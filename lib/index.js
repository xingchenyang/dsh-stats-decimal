 ...
 * half resolves the credential and calls DeepSeek, keeping both the key and
 * plugin-specific events out of the durable agent log.
 */
...
// Client view shape. The supported dsh v0.1.5-rc.1 projection contract exposes
 ...
 * endpoint returns the recharge balance using the host-resolved API key.
